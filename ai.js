...
if (!HF_TOKEN) {
  console.error("Missing HuggingFace API token! Please check your .env file");
}
...
export async function getRecipeFromMistral(ingredientsArr) {
  ...
  try {
    ...
    console.error("Error calling HuggingFace API:", err.message);
    return "Sorry, there was an error getting your recipe. Please check the API token configuration.";
  }
}
